  ...
  return (
    ...
    <button onClick={()=>isOpen(!open)} className="flex align-center gap-3">
        <Image src="/menu.png" alt="Back" width={30} height={30}/>
          ...
          <div className="absolute top-0 right-0 bg-black md:flex md:flex-col h-[895px]  pt-3  w-[300px] items-center ml-[6px] mt-[35px]  text-[#ffffff] border-solid border-2 rounded-xl border-white">
            <div>
